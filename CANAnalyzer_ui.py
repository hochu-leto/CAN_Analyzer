...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lab_warning_temperature.setText(_translate("MainWindow", "60C"))
        self.zone.setTitle(_translate("MainWindow", "Зона нечувствительности рейки"))
        self.lab_zone_of_insensitivity.setText(_translate("MainWindow", "3%"))
        self.warn_curr.setTitle(_translate("MainWindow", "Ток предупреждения - Аварийный"))
        self.lab_warning_current.setText(_translate("MainWindow", "50A"))
        self.cutoff.setTitle(_translate("MainWindow", "Ток отсечки"))
        self.lab_cut_off_current.setText(_translate("MainWindow", "70A"))
